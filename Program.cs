...
namespace Project
{
    class Program
    {
        ...
        class PongGame
        {
            ...
            private int score = 0;
            private int speed = 50; // speed in ms of delay
            ...
            private void Initialize()
            {
                ...
                // find the central position of paddle and ball
                paddleY = height / 2; 
                ballX = width / 2;
                ballY = height / 2;
            ...
            private void Logic()
            {
                ...
                if (ballX <= 0)
                {
                    isRunning = false; // if ball passes the paddle, "isRunning = false" ends the round
                }
            ...
            public void SaveScore(int score)
            {
                ...
                // ALSO save to SQLite
                DatabaseManager.InsertScore(playerName, score);
            }
        ...
        static void Main()
        {
            string dbPath = "PongGameDB.db";
            string csvPath = "score_csv.txt";
            // Clear any redundant data
            //DatabaseManager.ClearDB(dbPath);

            // Initialize DB
            DatabaseManager.InitializeDB(dbPath);         
            ...
            // Show top players
            DatabaseManager.PrintTopScores(10);
        }
    }
}
